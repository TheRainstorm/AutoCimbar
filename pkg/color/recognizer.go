...
// 只使用 0/96/255 分量，避免 Windows DXGI Desktop Duplication 在部分
// 显示配置下把 160 分量映射到 255，导致 16 色模式发生撞色。
var Color16Palette = []color.RGBA{
	...
	{R: 96, G: 255, B: 0, A: 255},
	{R: 255, G: 0, B: 96, A: 255},
	{R: 96, G: 0, B: 255, A: 255},
	{R: 255, G: 96, B: 96, A: 255},
	{R: 96, G: 255, B: 255, A: 255},
	{R: 255, G: 255, B: 96, A: 255},
	{R: 96, G: 96, B: 255, A: 255},
}
